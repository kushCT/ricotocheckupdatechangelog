    ...
    <div class="h-screen bg-gray-100 flex">
        ...
        <div class="flex-shrink-0 flex flex-col items-center py-8 justify-between w-20 border-r border-gray-200">
            ...
            <nav class="flex space-y-8 flex flex-col">
                <a href="#" class="text-yellow-300 p-3 lg:hover:text-yellow-300 bg-black rounded-md">
                    <svg class="w-6 h-6" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 6a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2V6zM14 6a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2V6zM4 16a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2v-2zM14 16a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2v-2z" />
                    </svg>
                </a>
                <a href="#" class="text-gray-500 p-3">
                    <svg class="w-6 h-6" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <header class="flex-shrink-0 border-b border-gray-200 px-14 py-4 relative flex items-center justify-between">
                ...
                <div class="flex-1 flex justify-center px-2 ml-6 lg:justify-start">
                    ...
                    <div class="relative w-2/6">
                        ...
                        <input id="search" name="search" class="block min-w-100 w-full pl-10 pr-10 py-3 border border-transparent rounded-full leading-5 bg-white text-gray-300 placeholder-gray-300 focus:outline-none focus:bg-white focus:border-white focus:ring-white focus:text-gray-600 sm:text-sm" placeholder="Search" type="search">
                    </div>
                </div>
