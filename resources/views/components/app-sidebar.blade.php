...
<div class="flex-shrink-0 flex flex-col w-24 bg-white shadow-sm">
    ...
    <div class="flex-grow flex flex-col items-center justify-between p-4">
        ...
        <div class="flex flex-col space-y-4">
            <a href="#" class="w-14 h-14 text-gray-300 flex justify-center items-center"
               title="{{ __('Create new organization') }}">
                <svg class="flex-none w-8 h-8" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                     stroke="currentColor">
