...
<li class="col-span-1 flex bg-white shadow-sm rounded-md py-4">
    ...
    <div class="flex-1 flex truncate">
        <div class="flex-1 px-2 truncate">
            ...
            <div class="flex -space-x-1 relative z-0 overflow-hidden pt-3">
                <img class="relative z-30 inline-block h-6 w-6 rounded-full ring-2 ring-black" src="https://images.unsplash.com/photo-1491528323818-fdd1faba62cc?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=facearea&facepad=2&w=256&h=256&q=80" alt="">
                <img class="relative z-20 inline-block h-6 w-6 rounded-full ring-2 ring-black" src="https://images.unsplash.com/photo-1550525811-e5869dd03032?ixlib=rb-1.2.1&auto=format&fit=facearea&facepad=2&w=256&h=256&q=80" alt="">
