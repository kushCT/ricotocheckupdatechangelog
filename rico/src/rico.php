...
{
    /**
     * Indicates if Rico routes will be registered.
     *
     * @var bool
     */
    ...
    /**
     * The user model that should be used by Rico.
     *
     * @var string
     */
    ...
    /**
     * The team model that should be used by Rico.
     *
     * @var string
     */
    ...
    /**
     * The membership model that should be used by Rico.
     *
     * @var string
     */
    ...
    /**
     * Determine if Rico has registered roles.
     *
     * @return bool
     */
    ...
    /**
     * Determine if any permissions have been registered with Rico.
     *
     * @return bool
     */
    ...
    /**
     * Determine if Rico is managing profile photos.
     *
     * @return bool
     */
    ...
    /**
     * Determine if Rico is supporting API features.
     *
     * @return bool
     */
    ...
    /**
     * Determine if Rico is supporting team features.
     *
     * @return bool
     */
    ...
    /**
     * Specify the user model that should be used by Rico.
     *
     * @param  string  $model
     * @return static
     */
    ...
    /**
     * Specify the team model that should be used by Rico.
     *
     * @param  string  $model
     * @return static
     */
    ...
    /**
     * Specify the membership model that should be used by Rico.
     *
     * @param  string  $model
     * @return static
     */
    ...
    /**
     * Manage Rico's Inertia settings.
     *
    ...
    /**
     * Configure Rico to not register its routes.
     *
     * @return static
     */
